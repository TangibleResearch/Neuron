...
VL_ATTR_COLD void Vregister_tb___024root___eval_static(Vregister_tb___024root* vlSelf) {
    ...
    // Body
    {
        ...
        vlSelfRef.register_tb__DOT__clk = 0U;
    }
    vlSelfRef.__Vtrigprevexpr___TOP__register_tb__DOT__clk__0 = 0U;
    do {
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vregister_tb___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
...
VL_ATTR_COLD bool Vregister_tb___024root___eval_stl(Vregister_tb___024root* vlSelf, CData/*0:0*/ firstIteration) {
    ...
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vregister_tb___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
    }
#endif
    return (0U);
}
...
VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__stl(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__stl\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
#ifdef VL_DEBUG
...
VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__ico(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__ico\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
#ifdef VL_DEBUG
...
VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__act(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__act\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
#ifdef VL_DEBUG
...
VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__nba(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__nba\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
#ifdef VL_DEBUG
    Vregister_tb___024root___dump_triggers__act(vlSelfRef.__VnbaTriggered, "nba"s);
#endif
}

VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__obs(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__obs\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vregister_tb___024root___eval_dump_triggers__react(Vregister_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___eval_dump_triggers__react\n"); );
    Vregister_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}
...
VL_ATTR_COLD bool Vregister_tb___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vregister_tb___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vregister_tb___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vregister_tb___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vregister_tb___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister_tb___024root___dump_triggers__ico\n"); );
    // Body
    if ((1U & (~ (IData)(Vregister_tb___024root___trigger_anySet__ico(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vregister_tb___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    // Body
    if ((1U & (~ (IData)(Vregister_tb___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @(posedge register_tb.clk)\n");
    }
...
VL_ATTR_COLD void Vregister_tb___024root___ctor_var_reset(Vregister_tb___024root* vlSelf) {
    ...
    vlSelf->register_tb__DOT__reset = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12389282434299742224ull);
    vlSelf->register_tb__DOT__write_enable = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6047694838906033662ull);
    vlSelf->register_tb__DOT__data_in = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2954630046384936636ull);
    vlSelf->register_tb__DOT__data_out = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16132451565483648653ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__register_tb__DOT__clk__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
